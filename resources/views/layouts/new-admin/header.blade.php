            ...
            <div class="d-flex order-lg-2 ml-auto">
                ...
                <div class="dropdown profile-dropdown">
                    <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                        <span>
                            <img src="{{ URL::asset('layouts/images/users/2.jpg') }}" alt="img"
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        <div class="text-center">
                            <a href="{{ url('/' . ($page = '#')) }}"
                                class="dropdown-item text-center user pb-0 font-weight-bold">{{ auth()->user()->nombre }}</a>
                        ...
                        <a class="dropdown-item d-flex" href="javascript:void" onclick="$('#logout-form').submit();">
